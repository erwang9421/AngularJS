...
.controller("mainctrl",function($scope){
	...
	$scope.sendMsg=function()
	{
		...
		newItem.innerHTML="<div class='m-l-lg'><a class='pull-left thumb-sm avatar'><img src='"+src+"'></a><div class='m-l-xxl panel b-a'><div class='panel-heading pos-rlt'><span class='arrow left pull-up'></span><span class='text-muted m-l-sm pull-right'>1m ago</span><a href=''>"+username+"：</a>"+msg+"</div></div></div>";
